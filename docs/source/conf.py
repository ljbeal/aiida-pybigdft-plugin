#
# Sphinx configuration for aiida-pybigdft-plugin
#
...
html_title = f"aiida-pybigdft-plugin v{release}"
html_theme_options = {}
...
html_use_opensearch = "https://aiida-pybigdft-plugin.readthedocs.io"
